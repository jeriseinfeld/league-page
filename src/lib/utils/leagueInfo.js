/*   STEP 1   */
export const leagueID = "1120135910676426752"; // your league ID
export const leagueName = "WHO SAID THAT?!"; // your league name
...
export const homepageText = `
  <p>Have you ever felt like a plastic bag.</p>
  <p>Caught in the landslide, with no escape or reality.</p>
  <p>Focus on the goal.</p>
  <p>crisch your enemies.</p>
  <p>9 times out of ten they beat us.</p>
  <p>go out there and kick it.</p>
`;
...
export const managers = [
    {
      ...
      "name": "Ric Steves",
      "location": "Wilmington, NC", // (optional)
      "bio": "Commish",
